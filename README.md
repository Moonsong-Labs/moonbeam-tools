...
<html>
  <head>
    ...
    <script src="https://unpkg.com/moonbeam-tools@0.0.42/dist/index.umd.js" charset="UTF-8" integrity="sha384-tIF9hiHELLDWhYYkzTQZ6piaSkTaCk+cOVuKMuKrJtwF9d4ZYRbYDsSLJRQXQuiN" crossorigin="anonymous"></script>
    <style>
      body {
        padding: 2rem;
      }
