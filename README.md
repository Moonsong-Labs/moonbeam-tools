...
<html>
  <head>
    ...
    <link rel="modulepreload" href="https://unpkg.com/moonbeam-tools@0.1.3/dist/index.js" charset="UTF-8" integrity="sha384-XKgD9Q8jbLB28P6SlFxzgXCen03G3TzFJwqybYrNvX798gVVXqOhDL5zbWBCkD/O" crossorigin="anonymous"></script>
    <style>
      body {
        padding: 2rem;
      }
  ...
  <body>
    ...
    <script type="module">
      import * as mbTools from "https://unpkg.com/moonbeam-tools@0.1.3/dist/index.js";
