...
SHA="$(cat dist/index.js | openssl dgst -sha384 -binary | openssl enc -base64 -A)"
...
sed -i.bak \
 ...
 -e "s|index.js\" charset=\"UTF-8\" integrity=\"sha384-[^\"]*|index.js\" charset=\"UTF-8\" integrity=\"sha384-$SHA|g" \
 README.md